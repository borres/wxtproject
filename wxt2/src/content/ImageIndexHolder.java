...
/**
 * Holding an index for used images
 * @author bs
 */
public class ImageIndexHolder
{
     ...
     */
    public ImageIndexHolder(Definitions d)
    {
        m_def=d;
     ...
     */
    public int addImageReference(String id,Module m)
    {

        if(m_def.getImage(id)==null)
            return -1;
