...
public class ScriptContent
{
   ...
   /** The owning module */
    ...
    public Transformation getTransformation(){return m_transformation;}
    public String getTransformationString(){return m_transformationString;}
    public HashMap<String,String> getTransformationParams(){return m_transParameters;}

    public URI getAbsoluteUri(){return m_absoluteUri;}
    public URI getAbsoluteBackupUri(){return m_absoluteBackupUri;}
    public URI getAbsoluteEffectiveUri(){return m_absoluteEffectiveUri;}

    public boolean usingBackup(){return m_absoluteBackupUri==m_absoluteEffectiveUri;}
