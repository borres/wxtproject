...
public class reporter extends java.lang.Object 
{
    ...
    /**Holding the stack*/
    Vector<String> m_Stack= new Vector<String>(10,10);
    ...
    static String m_Reportbundle="utils/reportstrings";
    ...
    public  String getReport(String scriptpath){
        ...
        for(int ix=0;ix<m_Stack.size();ix++){
            String thisMessage=m_Stack.elementAt(ix);
