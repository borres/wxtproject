...
public class Scripthandler {
    ...
    private Vector<Module> m_RootModules;
    ...
    Vector<Module>m_linearModuleList;
       ...
       while (n != null) {
            if ((n.getNodeType() == Node.ELEMENT_NODE) &&
                    (n.getNodeName().compareToIgnoreCase("definitions") == 0))
                        return new Definitions(this,(Element)n);
    ...
    */
    public Vector<Module> getRootModules() {
     ...
     */
      ...
      */
     public Vector<Module>getLinearModuleList()
     {
    ...
    private void establishStructure() {
        m_RootModules = new Vector<Module>(1);
        Node n = m_scriptDoc.getDocumentElement().getFirstChild();
        while (n != null) {
            if ((n.getNodeType() == Node.ELEMENT_NODE) &&
   ...
   */
    public void  buildModules(HashMap<String,String>arguments) 
    {
        ...
        // clear used images and remove images "made og the fly"
   ...
   */
    ...
    public Module getNextRoot(Module mod)
    {
        ...
        {
            Module m=m_RootModules.elementAt(ix);
            if(m.equals(mod) && (ix !=  m_RootModules.size()-1))
            {
                return m_RootModules.elementAt(ix+1);
            }
     ...
     */
    public Vector<Module> getAllModules(String rootid)
    {
     ...
     */
    public Vector<Module> getAllChildModules(String rootid)
    {
        Vector<Module> result =new Vector<Module>();
        if(rootid==null)
           return null;
     ...
     * @return A list of modules
     */
    public Vector<Module> getModuleListByXpath(String xp)
    {
        Vector<Module> result =new Vector<Module>();
        try{
     ...
     * @return The list of modules
     */
    public Vector<Module> getModuleListById(String[] ids,boolean aslisted)
    {
        Vector<Module> result =new Vector<Module>();
        if(aslisted)
        {
     ...
     * @return A list of modules
     */public Vector<Module> getModulesInBook(String[] bklist) 
    {
        Vector<Module> result =new Vector<Module>();
