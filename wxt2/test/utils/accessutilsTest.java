...
public class accessutilsTest {
    ...
    public void testgetIntegerList()
    {
        ...
        int limit=100;
        try {
            Vector<Integer> v = accessutils.getIntegerList(s,limit);
        ...
        try {
            ...
            assertEquals(1, (int)v.elementAt(0));
            assertEquals(6, (int)v.lastElement());
        } catch (Exception e) {
            fail(e.getMessage());
        }
        ...
        try {
            ...
            assertEquals(1, (int)v.elementAt(0));
            assertEquals(100, (int)v.lastElement());
        } catch (Exception e) {
            fail(e.getMessage());
        }
        ...
        try {
            ...
            assertEquals(0, (int)v.elementAt(0));
            assertEquals(7, (int)v.lastElement());
        } catch (Exception e) {
            fail(e.getMessage());
        }
        ...
        try {
            ...
            assertEquals(4, (int)v.elementAt(0));
            assertEquals(10, (int)v.lastElement());
        } catch (Exception e) {
            fail(e.getMessage());
        }
