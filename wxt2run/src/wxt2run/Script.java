...
import wxt2utils.wxt2rundomer;
import wxt2utils.treeMaker;
import wxt2utils.validationErrorHandler;
...
public class Script {
    ...
    throws Exception
    {
        ...
        try{
            ...
            m_doc=wxt2rundomer.makeDomFromUri(m_uri);
        }
        catch(Exception exp)
        {
    ...
    public String validateScript()
    {
       try{
            ...
            else
            {
                ...
                String result=wxt2rundomer.ValidateString(m_script,theUri,eHandler);
