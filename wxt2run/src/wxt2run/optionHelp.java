...
public class optionHelp extends javax.swing.JDialog {
    ...
    +"when there are no other way to decide encoding.</p>";
        T=T+"<h3>Reference Form</h3>"
    +"<p>Possible values are <em>simple</em>, <em>ieee</em>, <em>harvard</em>.<br>"
	+"Default is <em>simple</em>. Simple will produce a simple number, like [5],<br>"
	+"in the running text, and otherwise act as ieee.</p>";
    ...
    +"The books - value may be a commaseparated list.</p></div>";
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wxt2run.wxt2runApp.class).getContext().getResourceMap(optionHelp.class);
