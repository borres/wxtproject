 ...
 * Fragents are created from the script and from module:summary.
...
public class Fragment {
    ...
    /** the id value */
    private String m_id;
    /** modules who have used this fragment as aouthor*/
    List<Module>m_modulesAsAuthor=new ArrayList<Module>(5);
     ...
     */
    public boolean HasWrittenAnyOf(List<Module>modList)
    {
        if(!isAuthor())
            return false;
