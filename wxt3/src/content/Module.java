...
public class Module extends DefaultMutableTreeNode
{
     ...
     */
    public List<ScriptContent> getScriptContent(){return m_ScriptContent;}
    ...
    public String Inspector()
    {
        ...
        for(int ix=0;ix < m_ScriptContent.size();ix++)
        {
            ...
            if(m_ScriptContent.get(ix).usingBackup())
                bup="(backup)";
            sb.append("<tr>");
            sb.append("<td>XMLContent"+bup+"</td>"+tdstartcol2+m_ScriptContent.get(ix).getAbsoluteEffectiveUri().toString()+"</td>");
            sb.append("</tr>");
        }
        for(int ix=0;ix < m_ScriptContent.size();ix++)
        {
            ...
            if(m_ScriptContent.get(ix).usingBackup())
                bup="(backup)";
            sb.append("<tr>");
            sb.append("<td>TXTContent"+bup+"</td>"+tdstartcol2+m_ScriptContent.get(ix).getAbsoluteEffectiveUri().toString()+"</td>");
            sb.append("</tr>");
        }
