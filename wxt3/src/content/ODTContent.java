            ...
            if (e.getNodeName().compareTo("img")==0)
            {
                    ...
                    try{
                        ...
                        if(src.indexOf("xmlns:math")!=-1)
                        {
                            ...
                            try{
                                ...
                                Formula frm=Formula.makeFormulaFromSource(src, mod, cmd);
                                // notify globally
                                int globalindex=0;
                                if(mod.getDefinitions().getFormula(sid)!=null)
                                    globalindex=mod.getDefinitions().getFormulaHolder().addItemReference(sid,mod)+1;
                ...
                else
                {
                    ...
                    try{
                        ...
                        String height=null;
                        String alt=origsrc;
                        if(e.hasAttribute("width")) width=e.getAttribute("width");
                        if(e.hasAttribute("height")) width=e.getAttribute("height");
                        ...
                        if(mod.getDefinitions().getImage(id)!=null)
                            globalindex=mod.getDefinitions().getImageHolder().addItemReference(id,mod)+1;
                    }
                    catch(Exception uex)
                    {
