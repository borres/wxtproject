...
import wxt3utils.wxt3rundomer;
import wxt3utils.treeMaker;
import wxt3utils.validationErrorHandler;
...
public class Script {
    ...
    throws Exception
    {
        ...
        try{
            ...
            m_doc=wxt3rundomer.makeDomFromUri(m_uri);
        }
        catch(Exception exp)
        {
    ...
    public String validateScript()
    {
       try{
            ...
            else
            {
                ...
                String result=wxt3rundomer.ValidateString(m_script,theUri,eHandler);
