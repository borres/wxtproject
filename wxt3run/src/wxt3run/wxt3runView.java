...
import wxt3utils.JarFileLoader;
import wxt3utils.settings;
import wxt3utils.treeNode;
import org.jdesktop.application.Application;
import org.jdesktop.application.Application.ExitListener;
import org.jdesktop.application.Task;
import org.w3c.dom.Element;
import wxt3utils.resourceHandler;

/**
 * The application's main frame.
 */
public class wxt3runView extends FrameView   implements WindowListener
{
    ...
    public wxt3runView(SingleFrameApplication app) {
        super(app);
    ...
    public void showhelp() {
        wxt3runAboutBox box=new wxt3runAboutBox(null);
        box.launchelp();
    }
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = wxt3runApp.getApplication().getMainFrame();
            aboutBox = new wxt3runAboutBox(mainFrame);
        }
        aboutBox.setLocationRelativeTo(wxt3runApp.getApplication().getMainFrame());
        wxt3runApp.getApplication().show(aboutBox);
    }
    ...
    public void showVersions(){
        ...
        wxt3runApp.getApplication().show(versionBox);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wxt3run.wxt3runApp.class).getContext().getResourceMap(wxt3runView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(wxt3run.wxt3runApp.class).getContext().getActionMap(wxt3runView.class, this);
...
private void jMenuItemFindWxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemFindWxtActionPerformed
    ...
    if (result==JFileChooser.APPROVE_OPTION)
    {
        ...
        // set up wxt contact
        if(!setupWxt3Contract(m_wxtPath))
        {
...
private void jCheckBoxPreCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxPreCodeActionPerformed
    ...
    protected final void postInit()
    {
        ...
        // default 
        if(m_wxtPath==null)
            m_wxtPath="c:\\wxtproject\\wxt3\\dist\\wxt3.jar";
        ...
        if(!setupWxt3Contract(m_wxtPath))
        {
            ...
            m_wxtPath=null;
            jLabel6.setForeground(Color.RED);
            jLabel6.setText("-- wxt3 not connected --");
        }
        else
        {
            jLabel6.setForeground(Color.BLACK);
     ...
     */
    protected boolean setupWxt3Contract(String wxt3path)
    {
        if(wxt3path==null)
            return false;
        try{
            ...
            String oadr=wxt3path;
            jfl.addFile(oadr);
            m_Scripthandler=jfl.loadClass("wxt3.Scripthandler");
            ...
            m_Settings.setEntry(settings.WXTPATH, wxt3path);
            jButtonFindWxt.setVisible(false);
            

            // move files from wxt3? no! trouble with user.dir
    ...
    private class BuildTask extends org.jdesktop.application.Task<Object, Void> 
    {
        ...
        BuildTask(org.jdesktop.application.Application app){
           ...
           if((m_wxtPath==null)||(m_Constructor==null))
            {
                report="Cannot build. Dont know wxt.\nYou must set up path to catalog containing wxt3.jar first";
                doIt=false;
                return;                
            }
            if(m_currentScript==null)
        ...
        @Override protected Object doInBackground() throws Exception {
           ...
           try{
            ...
            {
                report+="Nullpointer exception in wxt3 build. Debugging case";
            }
            catch(Exception ex)
            {
     ...
     * That means constructing the wxt3:scripthandler
    ...
    private class StartUpdatingTask extends org.jdesktop.application.Task<Object, Void> {
       ...
       StartUpdatingTask(org.jdesktop.application.Application app) {
           ...
           if((m_wxtPath==null)||(m_Constructor==null))
            {
                report="Cannot build. Dont know wxt3.\nYou must set up path to wxt3.jar first";
                doIt=false;
                return;                
            }
            if(m_currentScript==null)
