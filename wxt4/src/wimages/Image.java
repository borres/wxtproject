...
public class Image implements indexable {
    ...
    /** default thumbheight*/
    public static final int DEFAULT_THUMBHEIGHT = 100;
    /**Max value for expected thumb size */
    public static int THUMBHEIGHT = 100;
    ...
    private String m_real_width;
    private int m_real_width_NUM = -1;
    /** the real height of this image*/
    private String m_real_height;
    private int m_real_height_NUM = -1;
    /** ratio for real values*/
    private float m_wh_ratio;
    /** the subtext of this image*/
    private String m_subText;
    /** styled width of subtext*/
    private String m_subTxtWidth;
    /** if generated from cmd (on the fly)*/
    private boolean m_on_the_fly;
    /** if generated from wiki or odt import*/
    private boolean m_on_import_wiki_or_odt;
    /** use this flag to avoid recalc*/
    private boolean has_calculated_real_size = false;
     ...
     * @param def The active Definitions object
    ...
    public DocumentFragment produceIntextElement(Module mod, PIcommand cmd) {
        ...
        if (cmd.getCommand().compareTo(PIcommand.IMAGETHUMB) == 0) {
            return produceSimpleThumbImage(mod, cmd);
        }
     ...
     * @return The result as a fragment    
     */
    private DocumentFragment produceSimpleThumbImage(Module mod, PIcommand cmd) {
        // produce thumb according to this pattern
        /* 
        <div class="wxtthumbwrapper">
        <img src="imref" alt="subtext"/>
