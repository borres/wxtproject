...
public class Scripthandler {
    ...
    /** arguments from main (command line) that controls the building*/
     ...
     * @param options
     */
    public final void controlOptions(HashMap<String, String> options) {
        ...
        if (options.containsKey(Definitions.VERBOSE)) {
            String tmp = (options.get(Definitions.VERBOSE));
            tmp = tmp.toLowerCase();
            if ((tmp.compareTo(Definitions.NO) != 0)
                    && (tmp.compareTo(Definitions.YES) != 0)) {
                m_Reporter.pushMessage("bad_option", Definitions.VERBOSE + "=" + tmp);
                // set default
                options.put(Definitions.VERBOSE, Definitions.NO);
            } else {
                options.put(Definitions.VERBOSE, tmp);
            }
        }
    }
    ...
    private Definitions collectDefinitions() {
        ...
        return new Definitions(this, (Element) deflist.item(0));
    }
    ...
    /**
     * Access the latest version distributed as a string: v.yyyy.mm.dd
     * @return The version compiled
     */
        ...
        if (arguments != null) {
            ...
            for (String key : keys) {
                ...
                if ((key.compareTo(Definitions.EXPAND_ALL) == 0)
                        ...
                        || (key.compareTo(Definitions.VERBOSE) == 0)
