...
import wxt4utils.wxt4rundomer;
import wxt4utils.treeMaker;
import wxt4utils.validationErrorHandler;
...
public class Script {
    ...
    throws Exception
    {
        ...
        try{
            ...
            m_doc=wxt4rundomer.makeDomFromUri(m_uri);
        }
        catch(Exception exp)
        {
    ...
    public String validateScript()
    {
       try{
            ...
            else
            {
                ...
                String result=wxt4rundomer.ValidateString(m_script,theUri,eHandler);
