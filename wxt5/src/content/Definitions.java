...
public class Definitions {
    ...
    /** holding a jsoupEngine*/
    XmlStringCleaner m_soupEngine;
    ...
    private void collectFromScript() {
        ...
        if (tvalue.compareToIgnoreCase(YES) == 0) {
            m_soupEngine=new XmlStringCleaner(m_options.get(DEFAULT_ENCODING),m_reporter);
        }*/
    ...
    public Scripthandler getScriptHandler() {
     ...
     /**
     * 
     * @return the XmlStringCleaner object if it exists
     */
    public XmlStringCleaner getSoupEngine() {
