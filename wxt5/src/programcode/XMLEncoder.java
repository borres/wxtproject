...
public class XMLEncoder extends DefaultHandler2 {
    ...
    public String parseText(String source, String enc, reporter theReporter) {
        ...
        try {
            ...
            theReporter.pushMessage("error_xml_encoder", source, se.getMessage());
            return null;
        } catch (ParserConfigurationException pce) {
            System.out.println(pce.getMessage() + " in: " + source);
            //theReporter.pushSimpleMessage(pce.getMessage());
            theReporter.pushMessage("error_xml_encoder", source, pce.getMessage());
            return null;
        } catch (IOException ie) {
            System.out.println(ie.getMessage() + " in: " + source);
            //theReporter.pushSimpleMessage(ie.getMessage());
            theReporter.pushMessage("error_xml_encoder", source, ie.getMessage());
            return null;
        } catch (Exception nex) {
            System.out.println(nex.getMessage() + " in: " + source);
            //theReporter.pushSimpleMessage(nex.getMessage());
            theReporter.pushMessage("error_xml_encoder", source, nex.getMessage());
            return null;
        }
