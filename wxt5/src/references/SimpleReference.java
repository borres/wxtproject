 ...
 * 
 */
public class SimpleReference implements indexable {
    /*
    ...
    protected final String AUTHORS_IN_LIST = "authorsinlist";
    protected final String AUTHORS_IN_TEXT = "authorsintext";
    protected final String SORTKEY = "sortkey";
     ...
     */
    public SimpleReference(Element elt, reporter r) throws Exception {
     ...
     */
    protected Node makePropertyElement(String prop, Module m) {
