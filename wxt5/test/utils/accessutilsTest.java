    ...
    public void testsetCommonEntities(){
      ...
      try{
        ...
        catch(Exception e)
        {
         ...
         @Test
    public void getBOMSafeTextFile(){
       try{
           String S="hansen";
           String outS= 
                   accessutils.getBOMSafeTextFile(new URI("http://www.it.hiof.no/~borres/diverse/wxttstfiles/hansenutf8nobom.txt"), "utf-8");
           assertEquals(S,outS);
        }
        catch(Exception e)
        {
      ...
      try{
           String S="hansen";
           String outS= 
                   accessutils.getBOMSafeTextFile(new URI("http://www.it.hiof.no/~borres/diverse/wxttstfiles/hansenutf8bom.txt"), "utf-8");
           assertEquals(S,outS);
        }
        catch(Exception e)
        {
      ...
      try{
           String S="hansen";
           String outS= 
                   accessutils.getBOMSafeTextFile(new URI("file:///c:/wxtproject/hansenutf8bom.txt"),"UTF-8");
           assertEquals(S,outS);
        }
        catch(Exception e)
        {
      ...
      try{
           String S="hansen";
           String outS= 
                   accessutils.getBOMSafeTextFile("c:\\wxtproject\\hansenutf8bom.txt","UTF-8");
           assertEquals(S,outS);
        }
        catch(Exception e)
        {
