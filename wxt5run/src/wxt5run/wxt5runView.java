...
import wxt5utils.JarFileLoader;
import wxt5utils.settings;
import wxt5utils.treeNode;
import org.jdesktop.application.Application;
import org.jdesktop.application.Application.ExitListener;
import org.jdesktop.application.Task;
import org.w3c.dom.Element;
import wxt5utils.resourceHandler;

/**
 * The application's main frame.
 */
public class wxt5runView extends FrameView   implements WindowListener
{
    ...
    public wxt5runView(SingleFrameApplication app) {
        super(app);
    ...
    public void showhelp() {
        wxt5runAboutBox box=new wxt5runAboutBox(null);
        box.launchelp();
    }
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = wxt5runApp.getApplication().getMainFrame();
            aboutBox = new wxt5runAboutBox(mainFrame);
        }
        aboutBox.setLocationRelativeTo(wxt5runApp.getApplication().getMainFrame());
        wxt5runApp.getApplication().show(aboutBox);
    }
    ...
    public void showVersions(){
        ...
        wxt5runApp.getApplication().show(versionBox);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wxt5run.wxt5runApp.class).getContext().getResourceMap(wxt5runView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(wxt5run.wxt5runApp.class).getContext().getActionMap(wxt5runView.class, this);
...
private void jMenuItemFindWxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemFindWxtActionPerformed
    ...
    if (result==JFileChooser.APPROVE_OPTION)
    {
        ...
        // set up wxt contact
        if(!setupWxt5Contract(m_wxtPath))
        {
...
private void jCheckBoxPreCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxPreCodeActionPerformed
    ...
    protected final void postInit()
    {
        ...
        // default 
        if(m_wxtPath==null)
            m_wxtPath="c:\\wxtproject\\wxt5\\dist\\wxt5.jar";
        ...
        if(!setupWxt5Contract(m_wxtPath))
        {
            ...
            m_wxtPath=null;
            jLabel6.setForeground(Color.RED);
            jLabel6.setText("-- wxt5 not connected --");
        }
        else
        {
            jLabel6.setForeground(Color.BLACK);
     ...
     */
    protected boolean setupWxt5Contract(String wx5path)
    {
        if(wx5path==null)
            return false;
        try{
            ...
            String oadr=wx5path;
            jfl.addFile(oadr);
            m_Scripthandler=jfl.loadClass("wxt5.Scripthandler");
            ...
            m_Settings.setEntry(settings.WXTPATH, wx5path);
            jButtonFindWxt.setVisible(false);
            

            // move files from wxt5? no! trouble with user.dir
    ...
    private class BuildTask extends org.jdesktop.application.Task<Object, Void> 
    {
        ...
        BuildTask(org.jdesktop.application.Application app){
           ...
           if((m_wxtPath==null)||(m_Constructor==null))
            {
                report="Cannot build. Dont know wxt.\nYou must set up path to catalog containing wxt5.jar first";
                doIt=false;
                return;                
            }
            if(m_currentScript==null)
        ...
        @Override protected Object doInBackground() throws Exception {
           ...
           try{
            ...
            {
                report+="Nullpointer exception in wxt5 build. Debugging case";
            }
            catch(Exception ex)
            {
     ...
     * That means constructing the wxt5:scripthandler
    ...
    private class StartUpdatingTask extends org.jdesktop.application.Task<Object, Void> {
       ...
       StartUpdatingTask(org.jdesktop.application.Application app) {
           ...
           if((m_wxtPath==null)||(m_Constructor==null))
            {
                report="Cannot build. Dont know wxt5.\nYou must set up path to wxt5.jar first";
                doIt=false;
                return;                
            }
            if(m_currentScript==null)
