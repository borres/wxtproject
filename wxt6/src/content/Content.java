...
public abstract class Content {
    ...
    String m_encoding;
    /** default encoding*/
    static final String DEFAULT_ENCODNG="UTF-8";
    ...
    public Content(Module owner, PIcommand cmd)
        ...
        if (m_Cmd.paramExist(PIcommand.LOCATION)) {
            ...
            throw new Exception(reporter.getBundleString("missing_location_in_content"));
        }
     ...
     * @param mod The module that has requested this content
     * @param cmd The PIcommand that describes what we want
     * @param wrapper The element owning the elements to clean
     */   
    public  void  cleanOneElement(Module mod, PIcommand cmd,Element wrapper,boolean keepLinks,boolean keepStyle){
