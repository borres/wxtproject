...
public class CodeFormatter {
    ...
    static public Definitions s_Def=null;
        ...
        switch(type){
            case CodeBasics.LANG_XML:
                ...
                try {
                    ...
                    preparedText = xe.parseText(txt, encoding, theReporter,true);
