...
public final class PIcommand extends java.lang.Object {
    ...
    public static final String IMPORTHTML = "importhtml";
    ...
    public static final String REMOVEGRANDPARENT = "removegrandparent";
    // formulas as image
    ...
    public static final String KEEPLINKS = "keeplinks";
    public static final String KEEPSTYLE = "keepstyle";
    ...
    public String controlPI() {
        ...
        switch(m_Cmd){
            ...
            case IMPORTHTML://----------------------------------------IMPORTHTML --------------------
                //if(!m_params.containsKey(LOCATION))
                //    return " missing "+LOCATION;
                if (m_params.containsKey(KEEPLINKS)) {
                    if (!YesOrNo(m_params.get(KEEPLINKS))) {
                        return KEEPLINKS + " must be yes or no";
                    }
                }                
                if (m_params.containsKey(KEEPSTYLE)) {
                    if (!YesOrNo(m_params.get(KEEPSTYLE))) {
                        return KEEPSTYLE + " must be yes or no";
                    }
                }  
                
                if(m_params.containsKey(REMOTE)){
                     if (!YesOrNo(m_params.get(REMOTE))) {
                        return REMOTE + " must be yes or no";
                    }                   
                }                
                ...
                // must have xpath or cssselector, could default it to:body > *
                /*if ( !m_params.containsKey(CSSSELECTOR) &&
                        (!m_params.containsKey(XPATH))) {
                    return CSSSELECTOR+" or "+XPATH + " must be set";
                }
                if(m_params.containsKey(REMOTE)){
                    if (!YesOrNo(m_params.get(REMOTE))) {
                          return REMOTE + " must be yes or no";
            ...
            case COLLECTREMOTE://----------------------------------COLLECTREMOTE --------------------
                if (!m_params.containsKey(XPATH)) {
                    return " missing " + XPATH;
                }
                if (!m_params.containsKey(LOCATION)) {
            ...
            case COLLECTSUMMARY://--------------------------------COLLECTSUMMARY --------------------
            ...
            case FRAGMENT://--------------------------------------------FRAGMENT --------------------
                ...
                if (m_params.containsKey(FORM)) {
                    ...
                    if ((!tmp.equals(ID)) && (!tmp.equals(SHORT))&& (!tmp.equals(FULL))) {
                        return FORM + " must be " + ID + " , " + SHORT + " or " + FULL;
                    }
                }
                return OK;        
        
            case POPFRAGMENT://--------------------------------------POPFRAGMENT --------------------
                if (!m_params.containsKey(ID)) {
                    return " missing " + ID;
                }
                if (m_params.containsKey(FORM)) {
                    if ((!m_params.get(FORM).equals(ID))
                            && !(m_params.get(FORM).equals(SHORT))
                            && (!m_params.get(FORM).equals(FULL))) {
            ...
            case MODULEMAP://------------------------------------------MODULEMAP --------------------
                if (m_params.containsKey(SUMMARY)) {
                 ...
                 if (m_params.containsKey(SELECT)) {
                     if ((!m_params.get(SELECT).equals(CHILDREN)) 
                             && (!m_params.get(SELECT).equals(SIBLINGS))) {
                         return SELECT + " must be " + SIBLINGS + " or " + CHILDREN;
                     }
                 }
            ...
            case EXPAND://------------------------------------------------EXPAND--------------------
               ...
               tmp1 = m_params.get(LOCATION);
               tmp2 = m_params.get(SOURCELOCATION);
               if ((tmp2 != null) && (tmp1.equals(tmp2))) {
                   return " cannot have identical " + LOCATION + " and " + SOURCELOCATION;
               }
               if (m_params.containsKey(CODE)) {
            ...
            case REFLIST://----------------------------------------------REFLIST --------------------
                if (m_params.containsKey(SCOPE)) {
                    if ((!m_params.get(SCOPE).equals(GLOBAL)) && (!m_params.get(SCOPE).equals(LOCAL))) {
            ...
            case FORMULA://----------------------------------------------FORMULA --------------------
                ...
                if (m_params.containsKey(TYPE)) {
                    ...
                    if ((typ.equals(IMAGE)) && (!m_params.containsKey(LOCATION))) {
            ...
            case FOOTNOTE://--------------------------------------------FOOTNOTE --------------------
                if (m_params.containsKey(FORM)) {
                    ...
                    if ((f.equals(NORMAL)) || (f.equals(SHOW)) || (f.equals(REMOVE))) {
                        return OK;
                    } else {
            ...
            case DATE://----------------------------------------------------DATE --------------------
                if (m_params.containsKey(FORM)) {
                    String f = m_params.get(FORM);
                    if ((!f.equals(SHORT)) && (!f.equals(MEDIUM)) && (!f.equals(LONG)) && (!f.equals(FULL))) {
            ...
            case MODULETOC://------------------------------------------MODULETOC --------------------
            case MODULETOCFINAL://--------------------------------MODULETOCFINAL --------------------
                if (m_params.containsKey(COLS)) {
                    if (!nonNegativeInteger(m_params.get(COLS))) {
                        return COLS + " must be an integer >= 0";
                    }
            ...
            case AUTHORLIST://----------------------------------------AUTHORLiST --------------------
                if (m_params.containsKey(SELECT)) {
                     if ((!m_params.get(SELECT).equals(CHILDREN)) && (!m_params.get(SELECT).equals(SIBLINGS))) {
                         return SELECT + " must be " + SIBLINGS + " or " + CHILDREN;
                     }
                 }
            ...
            case GADGET://------------------------------------------------GADGET --------------------
                if ((!paramExist(LOCATION)) && (!paramExist(FRAGMENTID))) {
                  ...
                  if (paramExist(POSITION)) {
                      if ((!m_params.get(POSITION).equals("absolute"))
                              && (!m_params.get(POSITION).equals("fixed"))
                              && (!m_params.get(POSITION).equals("relative"))
                              && (!m_params.get(POSITION).equals("static"))
                              && (!m_params.get(POSITION).equals("inherited"))) {
            ...
            case PATH://----------------------------------------------------PATH --------------------
            case STAMP://--------------------------------------------------STAMP --------------------
            case REFERENCETEST://----------------------------------REFERENCETEST --------------------
                return OK;
