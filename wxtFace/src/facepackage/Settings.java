...
public class Settings{
    ...
    HashMap<String,String> m_values=new HashMap();
    /** storing scriptcfiles */
    List<String>m_scripts=new ArrayList();
    ...
    public Settings()
    {
        m_filename=System.getProperty("user.home")+File.separatorChar+"wxtFaceSettings.txt";
    }
